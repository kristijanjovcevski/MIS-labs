...
class MainListScreenState extends State<MainListScreen> {
  final List<Exam> exams = [
    Exam(course: 'MIS - management', timestamp: DateTime(2023,10,15)),
    Exam(course: 'IDS', timestamp: DateTime(2023, 11, 11)),
    Exam(course: 'CE', timestamp: DateTime(2023, 10, 08)),
    Exam(course: 'TP', timestamp: DateTime(2023, 12, 09)),
    Exam(course: 'MIS - mobile', timestamp: DateTime(2023, 12, 01)),
    Exam(course: 'PVG', timestamp: DateTime(2023, 11, 01))
      ...
      appBar: AppBar(
        ...
        actions: [
          Row(
            children: [
              Container(
                margin: const EdgeInsets.only(right: 15.0), // Add custom margin
                child: IconButton(
              ...
              Container(
                margin: const EdgeInsets.only(right: 30.0), // Add custom margin
                child: IconButton(
