...
class MainListScreenState extends State<MainListScreen> {
  final List<Exam> exams = [
    Exam(course: 'TP', timestamp: DateTime(2023,11,15)),
    Exam(course: 'CE', timestamp: DateTime(2023, 12, 07)),
    Exam(course: 'MIS', timestamp: DateTime(2023, 10, 10)),
    Exam(course: 'PVG', timestamp: DateTime(2023, 10, 17)),
    Exam(course: 'DB', timestamp: DateTime(2023, 11, 11)),
    Exam(course: 'DS', timestamp: DateTime(2023, 12, 01))
  ];
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final formattedTimestamp = DateFormat('dd.MM.yyyy').format(timestamp);
